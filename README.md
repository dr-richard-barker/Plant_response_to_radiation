...
The raw OSD-782 count matrix (`data/osd782_normalized_counts.csv`, ~14 MB) is **not tracked** — it
is a direct OSDR download, regenerated by `code/15_osd782_validation.py` (source:
`https://osdr.nasa.gov/osdr/data/osd/files/782`). All other derived data are included; the full
FAIR bundle is also archived on Zenodo (see manuscript).
