    ...
    astrobotany: { label: "AstroBotany", sections: [
      { name:"Analyses", blurb:"Spaceflight & radiation transcriptomics / multi-omics studies.",
        ids:["arabidopsis-drem-osdr","Plant_response_to_radiation","Airflow_omics","arabidopsis-spaceflight-omics","APEX05_results_and_code",
             ...
             "arabidopsis-gwas-spaceflight","OSD615-glycome-cytoskeleton-systems-biology","OSDR_Plant_Alternative_Splicing"] },
    ...
    deepspaceag: { label: "Deep Space Agriculture", sections: [
      { name:"Plant systems & crops", blurb:"Growth-chamber gas transport, radiation, germination and crop physiology off Earth.",
        ids:["LunarLeaf-CFD","Airflow_omics","Aero-leaf-CFD-analysis-adapted-from-blender-ish","spaceflight-plant-hardware-cfd","Plant_response_to_radiation","B_rappa_LLGCSS","PhysioSpace_stress_decoding_VEG05","germinator-ai","Seed_sowing_simulator","lunar-magnetic-biology","AstroRegolith","AstroMycology","microgreen-chamber-cfd","fungal-bgc-atlas","biosim-nextgen","VEGGIE_Tom_Red_Blue_Leaves_and_adv_roots",
             "OSDR-Veggie-Nutrition-Dashboard","brachypodium-gwas-spaceflight","Microbiome_of_seedlings_in_space"] },
  ...
  groups: [
    {
      ...
      items: [
        ...
        { id:"Photorespiration_multiomics_microgravity", emoji:"🍃", title:"Hardware atmosphere vs microgravity",
          desc:"Interactive gas-transport + photosynthesis model, and the OSDR omics that test it",
    ...
    },
    {
      ...
      items: [
        ...
        { id:"SpaceMineralAtlas", emoji:"🦴", title:"SpaceMineralAtlas",
          desc:"Mining NASA LSDA and OSDR for spaceflight mineral-ion and dietary data (Ca, Mg, K, P) & bone/muscle countermeasures",
          url:"https://dr-richard-barker.github.io/SpaceMineralAtlas/", thumb_ext:"gif" },
        ...
        { id:"brachypodium-gwas-spaceflight", emoji:"🌾", title:"AstroGrass — Brachypodium GWAS",
          desc:"Brachypodium gravitropism GWAS & ISS spaceflight multi-omics targeting monocot candidate crops for long-duration space agriculture",
          url:"https://dr-richard-barker.github.io/brachypodium-gwas-spaceflight/", thumb_ext:"gif" },
        { id:"OSD615-glycome-cytoskeleton-systems-biology", emoji:"🕸️", title:"OSD-615 Glycome-Cytoskeleton Dashboard",
          ...
          url:"https://dr-richard-barker.github.io/OSD615-glycome-cytoskeleton-systems-biology/", thumb_ext:"gif" },
        { id:"OSDR_Plant_Alternative_Splicing", emoji:"✂️", title:"Plant Spaceflight Alternative Splicing",
          ...
          url:"https://dr-richard-barker.github.io/OSDR_Plant_Alternative_Splicing/", thumb_ext:"gif" },
        { id:"Microbiome_of_seedlings_in_space", emoji:"🦠", title:"Seedling Space Microbiome",
          desc:"Metagenomic meta-analysis investigating root-associated and phyllosphere microbial communities of seedlings in spaceflight",
          url:"https://dr-richard-barker.github.io/Microbiome_of_seedlings_in_space/", thumb_ext:"gif" },
        { id:"nssdc-cosmic-explorer", emoji:"🛰️", title:"NSSDC Cosmic Explorer",
          desc:"Multi-mission space science and planetary exploration data visualization platform (CNSA Chang'e, Tianwen, and solar wind)",
          url:"https://dr-richard-barker.github.io/nssdc-cosmic-explorer/", thumb_ext:"gif" },
